...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
            ...
            <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                ...
                <a  class="login-logo pb-xl-20 pb-15" style="text-align: center;" >
                    <img src="{{settings('logo_login')}}" class="max-h-70px" alt="" />
                </a>
                <!--end::Logo-->
                <!--begin::Signin-->
                <div class="login-form">
                    ...
                    <form class="form" id="" method="POST" action="{{route('login')}}">
                        ...
                        <div class="pb-5 pb-lg-15" style="text-align: center;">
                            <h3 class="font-weight-bolder text-warning font-size-h2 font-size-h1-lg">تسجيل الدخول</h3>
                        </div>
                        <!--begin::Title-->
                        <!--begin::Form group-->
                        ...
                        <div class="pb-lg-0 pb-5" style="text-align: center;">
                            <button type="submit" id="kt_login_singin_form_submit_button" class="btn btn-warning font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">تسجيل الدخول</button>
                        </div>
                        <!--end::Action-->
                    </form>
                    <!--end::Form-->
        ...
        <!--begin::Content-->
        <!--begin::Aside-->
        <div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right" style="background-image: url({{settings('login_pg')}}); width: 900px;">
