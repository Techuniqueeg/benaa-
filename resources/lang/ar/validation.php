...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'phone' => 'رقم الهاتف',
        'price' => 'السعر',
        'mainimage' => 'الصوره الاساسيه',
        'images' => 'صور المنتج المتعدده',
        'cat_id' => 'القسم',
        'type_id' => 'النوع',
        'group_id' => 'الفئه',
        'brand_id' => 'العلامه التجاريه',
        'size' => 'الوزن',
        'code' => 'الكود',
        'details' => 'الوصف',
        'product_id'=>'رقم التعريفي للمنتج',
        'lat'=>'رقم خط العرض',
        'lng'=>'رقم خط الطول',
        'street'=>'الشارع',
        'region'=>'المنطقه',
        'building'=>'المبني',
        'quantity'=>'الكميه',
        'adress_id'=>'رقم التعريفي للعنوان',
        'page_id'=>'رقم التعريفي للصفحه',
        'area'=>'المساحه',
        'category_id'=>'القسم',
        'location_id'=>'المنطقه',
        'area_id'=>'المساحه',
